...
namespace Piwik\Plugins\ProfileGravatar\RecordBuilders;
...
use Piwik\DataTable;
use Piwik\Metrics;
use Piwik\Plugins\ProfileGravatar\Archiver;

class Uv extends RecordBuilder
{
    ...
    {
        return [
            Record::make(Record::TYPE_BLOB, Archiver::GRAVATAR_HASH_RECORD_NAME),
        ];
    }
    ...
    protected function aggregate(ArchiveProcessor $archiveProcessor): array
    {
        ...
        $cursor = $archiveProcessor->getLogAggregator()->queryVisitsByDimension(['label' => Archiver::GRAVATAR_HASH_DIMENSION]);
        ...
        return [Archiver::GRAVATAR_HASH_RECORD_NAME => $record];
    }
}
